...
$res_munis = mysql_query($sql_munis) or die (mysql_error());
 ...
 ?>
 	<form action="buscar_muni.php" name="buscar_paso2" method="post">
	<table align="center">
	...
	<tr><td>Búsqueda con filtros:</td><td><input type="radio" name="criterio" value="filtros"/></td></tr>
...
<? 	
	...
	else if ($_POST["buscar_paso2"])
	{
		...
		{ ?><form action="mostrar_uno_muni.php" method="post">
			<table align="center">
...
<?		}
		...
		{ ?><form action="mostrar_uno_muni.php" name="buscar_paso3" method="post">
			<table align="center">
...
<?		}
		else if ($_POST["criterio"]=='filtros')
		{ 
		$_SESSION["criterio"]='filtros';
